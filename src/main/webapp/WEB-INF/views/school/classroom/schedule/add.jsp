...
<body>
	<form id="ff" method="post">
		<table class="editTable">
			...
			<tr>
				...
				<td><input id="classroomId" name="classroomId" type="hidden"> 
					<input id="dd" name="date" type="text"></td>
			</tr>
			<tr>
	...
	<script type="text/javascript">
		$(function() {
			...
			$('#ff').form({
				url : "${prePath}/school/classroom/schedule/add",
				onSubmit : function() {
			...
			//从父页的父页面(教室管理的页面)获取数据(教室id),并填充到表单
