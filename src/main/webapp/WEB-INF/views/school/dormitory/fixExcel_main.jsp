...
<body>
	...
	<script type="text/javascript">
		$('#dg').datagrid({
			//数据源
			url : '${prePath}/school/dormitory/getFixExcelPage',
			...
			toolbar : [ {
				...
				handler : function() {
					...
					$.messager.confirm('操作提示', '这是一个不可逆的操作,您确定要删除这些数据吗？', function(r){
						...
						$.ajax({
							type : "POST",//请求方式
							dataType : 'json',
							url : "${prePath}/school/dormitory/deleteFixExcel",//请求目的URL
				...
				handler : function() {
					...
					form.attr("action","${prePath}/school/dormitory/downloadFixExcel");
					//end form
					//定义input标签
					var input=$("<input>");  
